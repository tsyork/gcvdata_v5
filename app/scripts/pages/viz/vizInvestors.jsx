...
var InvestorsViz = React.createClass({
    ...
    componentDidMount: function(){
        ...
        var vizURL = "https://10ay.online.tableau.com/#/site/gcvdealsdata/views/Subscription_Beta/InvestorLandingPage";
        var options = {
            //width: '1200px',
            //height: '540px',
            hideToolbar: true,

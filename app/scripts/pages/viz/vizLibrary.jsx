...
var LibraryViz = React.createClass({
    ...
    componentDidMount: function(){
        ...
        var vizURL = "https://10ay.online.tableau.com/#/site/gcvdealsdata/views/Subscription_Beta/Library";
        var options = {
            //width: '1200px',
            //height: '540px',
            hideToolbar: true,
        ...
        LibraryViz = new tableauSoftware.Viz(vizDiv, vizURL, options);
    },

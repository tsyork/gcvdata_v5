...
var DealsViz = React.createClass({
    ...
    componentDidMount: function(){
        ...
        var vizURL = "https://10ay.online.tableau.com/#/site/gcvdealsdata/views/Subscription_Beta/DealsLandingPage";
        var options = {
            //width: '1200px',
            //height: '540px',
            hideToolbar: true,
        ...
        DealsViz = new tableauSoftware.Viz(vizDiv, vizURL, options);
    },
